...
def initConsts():
    ...
    states[3] = 0.000325
    constants[4] = 0.3
    constants[5] = constants[0]-112.000
...
def model_HH(V_0=-10,
    ...
    def init_p():
        ...
        states[3] = n_0
        constants[4] = gbar_L
        constants[5] = constants[0]-E_Na
        constants[6] = constants[0]+E_K
        constants[7] = constants[0]-E_l
        return (states,constants)
    ...
    #voi = linspace(0, 10, 50)
    end_time = 15          # ms
    dt = 0.025             # ms
    voi = np.arange(0, end_time + dt, dt)
    ...
    #r = odeint(computeRates, init_states, time)
    #values = r[:, 0]
