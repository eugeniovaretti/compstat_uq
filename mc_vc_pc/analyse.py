...
exact_data_6 =  un.Data("data/parameters_6/exact.h5")

pc_evaluations_6, pc_mean_errors_6, pc_variance_errors_6, pc_sobol_evaluations_6, pc_sobol_errors_6 = calculate_error("parameters_6/pc_*", exact_data_6)
mc_evaluations_6, mc_mean_errors_6, mc_variance_errors_6, mc_sobol_evaluations_6, mc_sobol_errors_6 = calculate_error("parameters_6/mc_*", exact_data_6)
...
with h5py.File("pc_mc.h5", "w") as f:
    ...
    f.create_dataset("pc_evaluations_6", data=pc_evaluations_6)
    f.create_dataset("pc_mean_errors_6", data=pc_mean_errors_6)
    f.create_dataset("pc_variance_errors_6", data=pc_variance_errors_6)
    f.create_dataset("pc_sobol_evaluations_6", data=pc_sobol_evaluations_6)
    f.create_dataset("pc_sobol_errors_6", data=pc_sobol_errors_6)


    f.create_dataset("mc_evaluations_6", data=mc_evaluations_6)
    f.create_dataset("mc_mean_errors_6", data=mc_mean_errors_6)
    f.create_dataset("mc_variance_errors_6", data=mc_variance_errors_6)
    f.create_dataset("mc_sobol_evaluations_6", data=mc_sobol_evaluations_6)
    f.create_dataset("mc_sobol_errors_6", data=mc_sobol_errors_6)
