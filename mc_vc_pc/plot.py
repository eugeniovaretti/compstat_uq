...
with h5py.File("pc_mc.h5", "r") as f:
    ...
    pc_evaluations_6 = f["pc_evaluations_6"][()]
    pc_mean_errors_6 = f["pc_mean_errors_6"][()]
    pc_variance_errors_6 = f["pc_variance_errors_6"][()]
    pc_sobol_evaluations_6 = f["pc_sobol_evaluations_6"][()]
    pc_sobol_errors_6 = f["pc_sobol_errors_6"][()]

    mc_evaluations_6 = f["mc_evaluations_6"][()]
    mc_mean_errors_6 = f["mc_mean_errors_6"][()]
    mc_variance_errors_6 = f["mc_variance_errors_6"][()]
    mc_sobol_evaluations_6 = f["mc_sobol_evaluations_6"][()]
    mc_sobol_errors_6 = f["mc_sobol_errors_6"][()]
...
prettyPlot(pc_evaluations_6, pc_mean_errors_6, linewidth=linewidth, nr_colors=nr_colors, color=0, ax=axes[1])
prettyPlot(pc_evaluations_6, pc_variance_errors_6, linewidth=linewidth, nr_colors=nr_colors, color=0, linestyle="--", ax=axes[1])
prettyPlot(pc_sobol_evaluations_6, pc_sobol_errors_6, linewidth=linewidth, nr_colors=nr_colors, color=0, linestyle=":", ax=axes[1])

prettyPlot(mc_evaluations_6, mc_mean_errors_6, linewidth=linewidth, nr_colors=nr_colors, color=1, ax=axes[1])
prettyPlot(mc_evaluations_6, mc_variance_errors_6, linewidth=linewidth, nr_colors=nr_colors, color=1, linestyle="--", ax=axes[1])
prettyPlot(mc_sobol_evaluations_6, mc_sobol_errors_6, linewidth=linewidth, nr_colors=nr_colors, color=1, linestyle=":", ax=axes[1])
